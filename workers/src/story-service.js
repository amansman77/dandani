...
const SEED_TOPICS = [
  ...
  '돈 걱정에 잠 못 이루는 밤',
  '오래된 친구와 멀어진 걸 느낀 순간',
  'SNS에 좋아 보이는 척 올리고 나서 드는 공허함',
  '몸이 보내는 신호를 계속 무시해온 것',
  '완벽하게 하려다 아예 시작을 못 하는 것',
  '화를 낸 뒤 사과할 타이밍을 놓친 것',
  '혼자 있는 시간이 무섭게 느껴진 것',
  '남들 앞에서 괜찮은 척하다 지친 것',
  '이별 후에도 습관처럼 연락처를 열어보는 것',
  '나이 들어가는 게 갑자기 낯설게 느껴진 순간',
  '하고 싶은 말을 삼키고 돌아서는 길',
  '남의 SNS 속 여행 사진에 괜히 초조해지는 마음',
  '오늘 하루도 그냥저냥 흘려보냈다는 죄책감',
  '아픈 걸 티 내지 못하고 참는 습관',
  '결정을 내리지 못해 제자리를 맴도는 마음',
  '칭찬을 받아도 있는 그대로 못 받아들이는 것',
];
